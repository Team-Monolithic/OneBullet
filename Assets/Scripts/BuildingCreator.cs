...
public class BuildingCreator : Singleton<BuildingCreator>
{
    ...
    private void Update()
    {
        if (_selectedObj != null)
        {
            ...
            if (gridPos != _currentGridPosition) // GridPosition 정보 갱신
            {
                ...
                UpdatePreview();
                if (holdActive && _selectedObj.BuildingCategory.PlaceType > PlaceType.Single)
                {
                    HandleDrawing();
                }
            }
    ...
    private void HandleDrawing()
    {
        if (_selectedObj != null)
        {
            switch (_selectedObj.BuildingCategory.PlaceType)
            {
    ...
    private void HandleDrawRelease()
    {
        if (_selectedObj != null)
        {
            if (_selectedObj.BuildingCategory.PlaceType == PlaceType.Line ||
                _selectedObj.BuildingCategory.PlaceType == PlaceType.Rectangle)
            {
                DrawBounds(tilemap); 
    ...
    {
        tilemap.SetTile(_currentGridPosition, _selectedObj.TileBase);
    }
}
